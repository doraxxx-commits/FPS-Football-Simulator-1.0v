...
class WorldEngine:
    ...
    def __init__(
        ...
        self._last_tables: dict[int, list[StandingsRow]] = {}
    ...
    def get_last_table(self, tier: int) -> list[StandingsRow]:
        """Tabela zakończonego sezonu, dostępna także po resecie nowego sezonu."""
        return self._last_tables.get(tier, self.get_table(tier))
